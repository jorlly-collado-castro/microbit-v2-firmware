...
Edit
Hardware
Details of the 2.0 micro:bit revision
...
More Info DAPLink, KL27 reference manual (behind login) KL27 datasheet
USB communications
...
Weight TBC
Further information
BBC Technical Specifications

I2C specification (behind login)

SPI ‘specification’

Fritzing diagram, contributed by Kok Ho Huen

Terms of Use Privacy Safeguarding Support Newsletter microbit.org
© Copyright 2026 Micro:bit Educational Foundation
